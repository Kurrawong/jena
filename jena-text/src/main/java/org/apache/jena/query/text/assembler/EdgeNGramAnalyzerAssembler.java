...
/**
 * Assembler for {@link EdgeNGramAnalyzer}.
 * <p>
 * Optional properties:
 * <ul>
...
public class EdgeNGramAnalyzerAssembler extends AssemblerBase {
    ...
    public Analyzer open(Assembler a, Resource root, Mode mode) {
        ...
        Statement minStmt = root.getProperty(TextVocab.pMinGram);
        if (minStmt != null) {
            minGram = minStmt.getInt();
        }

        Statement maxStmt = root.getProperty(TextVocab.pMaxGram);
        if (maxStmt != null) {
